...
個人的に作っているアプリで FSD というアーキテクチャを途中から採用していて、導入以前に書かれたコードはそれに沿っていないという状態だったので、Cline を使ってこの移行を完了させようと思った。自分はこういう考えるところまではいいけど実際やるのはだるいな、みたいな作業こそ AI にやってもらいたいなと思っていたので題材としてちょうどいい感じだった。

- https://github.com/feature-sliced
- https://zenn.dev/moneyforward/articles/e1ed48c3974811

どんなアプリかというと Chrome のサイドパネルとタブで動く GitHub の Issue/PR/Discussion リーダーで、分かる方は Jasper の Chrome 拡張版だと思ってもらうとイメージしやすいと思う。完全に自分用に作っているのでコードの公開とかは出来ないので、うまいこと察してほしい。アプリがわからなくとも話自体は分かるようにしているつもり。
...
達成したいこととして、当たり前だがこのリポジトリを今後 AI と滞りなく開発できるよう状態にしたい。一旦 Cline だとして、そのためには次の要素が必要だと考えた:
...
現状 AI 向けのルールやガードレールが一切存在していないので、それも同時に整備することを目標にする。
...
あとから思ったことだが、もっと細かく分けるべきだったのと、指定と時系列の把握が楽になるので連番を使いたいが、複数人の場合は GitHub Issue などと連携するようにしないとコンフリクトするリスクがある
...
ちなみにこれを書いている途中に `.clinerules` がディレクトリに出来るになった。
